...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Admin form submit with improved feedback
    if (adminEditForm) {
      adminEditForm.addEventListener('submit', function(e) {
        ...
        .then(data => {
          ...
          if (data.success) {
            // Show success message with custom notification instead of alert
        ...
        .catch(error => {
          ...
          showNotification('An error occurred while updating the profile: ' + error.message, 'error');
          // Re-enable the submit button
          submitBtn.disabled = false;
        });
      });
